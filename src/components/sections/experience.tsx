      ...
      <div className="space-y-8 sm:space-y-12 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-row gap-2 items-center">
            ...
            <Button
              variant="outline"
              onClick={() =>
                window.open(t("experience.registry.reacture"), "_blank")
              }
            >
              {t("experience.registry.reacture")}
            </Button>
            <Button
              variant="outline"
              onClick={() =>
                window.open(t("experience.registry.faktion"), "_blank")
              }
            >
              {t("experience.registry.faktion")}
            </Button>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-row gap-2 items-center">
            ...
            <Button
              variant="outline"
              onClick={() => window.open(t("experience.agentic.url"), "_blank")}
            >
